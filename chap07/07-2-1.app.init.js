...
TITLE: 모듈화하기
        ...
        이전 장(데이터베이스 사용하기)에서 만들었던 웹서버 중 중 일부 모듈화
...
var user = require('./route/07-2-1.user.init');
...
function createUserSchema(database) {
    ...
    UserSchema = require('./database/07-2-1.user_schema').createUserSchema(mongoose);
